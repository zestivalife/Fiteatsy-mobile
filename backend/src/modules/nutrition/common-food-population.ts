...
const CATEGORY_POLICY:Record<string,{roles:ComponentRole[];mealHeads:MealHead[];clientConsumable:boolean}>={
  ...
  nuts:{roles:['NUT_SEED','PROTEIN'],mealHeads:['EARLY_MORNING','BREAKFAST','MID_MORNING','EVENING_SNACK'],clientConsumable:true},
  seeds:{roles:['NUT_SEED'],mealHeads:['EARLY_MORNING','BREAKFAST','MID_MORNING','EVENING_SNACK'],clientConsumable:true},
