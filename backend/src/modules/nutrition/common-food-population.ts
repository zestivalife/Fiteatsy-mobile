...
const vegetarianClass=(food:CatalogueFood):CommonFood['vegetarianClass']=>food.foodCategory==='egg'?'EGG':['poultry','fish'].includes(food.foodCategory??'')?'NON_VEGETARIAN':food.dietaryTags.includes('non-vegetarian')?'NON_VEGETARIAN':food.dietaryTags.includes('vegan')?'VEGAN':'VEGETARIAN';
