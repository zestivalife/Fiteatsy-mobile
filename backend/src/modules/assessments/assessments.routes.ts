...
const toResultDto = (result: Awaited<ReturnType<typeof getAssessmentResultById>>) =>
  result
    ? {
        id: result.id,
...
const toSessionDto = (session: NonNullable<Awaited<ReturnType<typeof getAssessmentSession>>>) => ({
  id: session.id,
