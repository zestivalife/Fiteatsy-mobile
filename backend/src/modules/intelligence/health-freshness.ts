export const HEALTH_OBSERVATION_FRESHNESS_MS: Record<string, number> = {
  steps: 24 * 60 * 60 * 1000,
...
export const isCurrentHealthObservation = (
  observation: { metricType: string; measuredAtISO: string },
  nowMs = Date.now()
) => {
