...
const withoutInternalClientId = (record) => {
...
const careCaseDto = (careCase) => withoutInternalClientId(careCase);
const notificationDto = (notification) => withoutInternalClientId(notification);
const requireOwnedCareCase = async (req, res, careCaseId) => {
