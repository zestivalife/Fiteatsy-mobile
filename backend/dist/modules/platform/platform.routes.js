...
import { z } from 'zod';
import { assignConsultant, getHealthProfileBundle, listCareCaseEvents, listCareCaseTickets, listCareCaseTimeline, listUserNotifications, requestMissingInformation, upsertHealthProfile, } from './platform.service.js';
const getUserId = (req) => String(req.header('x-user-id') || req.body?.userId || req.query?.userId || 'demo-user').trim();
