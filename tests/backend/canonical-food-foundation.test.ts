...
import { assertIngredientSourceState, assertMandatoryNutritionVector, assertSourceMappingEligible, assertSourceRights, canonicalHash, createValidationRelease, evaluateStageBReview, ingestHumanGateSubmission, ingredientIdentityKey, measureCoverage, servingVariant, type CanonicalIngredientIdentity, type SourceMapping, type StageBReviewInput } from '../../backend/src/modules/nutrition/food-curation/canonical-food-foundation.js';
