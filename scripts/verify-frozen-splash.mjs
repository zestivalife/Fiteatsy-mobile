...
requireText(splashSource, 'fiteatsy-logo.svg', 'static splash');
rejectText(splashSource, 'expo-video', 'static splash');
rejectText(splashSource, 'VideoView', 'static splash');
rejectText(splashSource, '.mp4', 'static splash');
requireText(splashSource, "backgroundColor: '#000000'", 'static splash');
requireText(splashSource, 'SPLASH_MIN_DURATION_MS = 1_200', 'static splash');
requireText(splashSource, 'SPLASH_MAX_DURATION_MS = 10_000', 'static splash');
