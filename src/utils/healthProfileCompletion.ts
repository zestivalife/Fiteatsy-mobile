...
import { calculateBmi, calculateBodyFatPercentage, calculateWaistHipRatio } from './canonicalBodyMetrics';
...
export { calculateBmi, calculateWaistHipRatio };
...
export const buildHealthProfileCompletion = (
  ...
  const calculatedBodyFatPct = calculateBodyFatPercentage({
  ...
  const bodyFatPct = onboarding?.bodyFatPct ?? calculatedBodyFatPct;
