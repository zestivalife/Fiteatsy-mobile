...
export const HEALTH_METRIC_REGISTRY: readonly HealthMetricDefinition[] = [
  ...
  {metricKey:'heart_rate',displayName:'Heart Rate',appleHealthType:'heart_rate',healthConnectRecord:null,unit:'bpm',aggregation:HEALTH_METRIC_SEMANTICS.heart_rate.display,permissionRequired:true,syncWindowDays:14,backendCanonicalType:'heart_rate',downstreamUsage:['heart']},
  ...
  {metricKey:'hydration',displayName:'Hydration',appleHealthType:'hydration_ml',healthConnectRecord:null,unit:'ml',aggregation:HEALTH_METRIC_SEMANTICS.hydration_ml.display,permissionRequired:true,syncWindowDays:28,backendCanonicalType:'hydration_ml',downstreamUsage:['hydration']},
  {metricKey:'spo2',displayName:'Blood Oxygen',appleHealthType:'spo2',healthConnectRecord:null,unit:'pct',aggregation:HEALTH_METRIC_SEMANTICS.spo2.display,permissionRequired:true,syncWindowDays:35,backendCanonicalType:'spo2',downstreamUsage:['respiratory']},
  {metricKey:'respiratory_rate',displayName:'Respiratory Rate',appleHealthType:'respiratory_rate',healthConnectRecord:null,unit:'brpm',aggregation:HEALTH_METRIC_SEMANTICS.respiratory_rate.display,permissionRequired:true,syncWindowDays:35,backendCanonicalType:'respiratory_rate',downstreamUsage:['respiratory']}
] as const;
