...
const styles = StyleSheet.create({
  ...
  balance: { flexDirection: 'row', gap: spacing.sm, borderRadius: radius.lg, borderWidth: 1, borderColor: '#205936', backgroundColor: '#0B1B13', padding: spacing.md }, balanceIcon: { width: 36, height: 36, borderRadius: radius.md, backgroundColor: '#10331F', alignItems: 'center', justifyContent: 'center' }, balanceTitle: { ...typography.bodyStrong, color: C.text, fontSize: 15 }, balanceBody: { ...typography.caption, color: '#75B184', fontSize: 12, lineHeight: 18, marginTop: spacing.xs }, balanceButton: { borderRadius: radius.md, backgroundColor: '#123922', padding: spacing.sm, marginTop: spacing.sm, alignItems: 'center' }, balanceButtonText: { ...typography.caption, color: C.green, fontFamily: 'Exo_600SemiBold' },
