...
export const ScreenHeader = ({ title, subtitle, back = true, onBack, fallbackRoute, action }: Props) => {
  const { themeMode } = useAppContext();
  const palette = getThemeColors(themeMode);
  return (
    <View style={styles.header}>
      {back ? <AppBackButton onPress={onBack} fallbackRoute={fallbackRoute} /> : <View style={styles.slot} />}
...
/** @deprecated Import ScreenHeader for new screens. */
